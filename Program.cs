...
var repoPath = @"I:\dev\myProjects";
var indexPath = @"I:\AI\indexes\code";
var vectorPath = @"I:\AI\indexes\vectors";//Save vector JSON
var memoryPath = @"I:\AI\memory\conversation.json";//Memory file path variable
...
void Log(string model, string prompt, string response)
{
...
string SuggestModel(string userInput)
{
...
List<string> GetCodeFiles(string rootPath)
{
...
List<string> ChunkFile(string content, int maxChunkSize = 2000)
{
...
List<string> RetrieveRelevantChunks(string query, string indexPath, int maxChunks = 3)
{
...
bool LooksLikeHallucination(string response)
{
...
List<string> ExtractSymbols(List<string> chunks)
{
...
List<string> ExpandContext(List<string> initialChunks, string indexPath, int maxExpanded = 5)
{
...
async Task<List<string>> RetrieveSemanticChunks(
    string query,
    string vectorPath,
    int maxChunks = 3)
{
...
async Task<List<string>> RetrieveHybridChunks(
    string query,
    string indexPath,
    string vectorPath,
    int maxChunks = 5)
...
string CompressChunk(string content, int maxLength = 1200)
{
...
string BuildSmartContext(List<string> chunks, int maxContextLength = 12000)
{
